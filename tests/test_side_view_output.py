...
def test_side_view_outputs_dxf_png_and_report(tmp_path):
    ...
    assert "side_clearance_height_formula: 27.000000 - 12.000000 - 1.830000 + 0.135255 = 13.305255" in report
    assert "measured_side_clearance_height_from_dimension_group_42: 13.305255" in report
