...
def test_single_real_company_spec_r16_release_output(tmp_path):
    ...
    assert side_measurements["13.23"][0] == pytest.approx(13.230326074)
    assert side_group_42["12.50"][0] == pytest.approx(12.50)
    assert side_group_42["13.23"][0] == pytest.approx(13.230326074)
    ...
    assert side_geometry["clearance_height"] == pytest.approx(13.230326074, abs=0.001)
